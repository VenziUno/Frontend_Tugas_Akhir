    ...
    <div ref={ref}>
      {printItem &&
        printItem.map((item, index) => (
          <div key={index} className="grid grid-cols-2 gap-5 mx-4 mt-2">
            {[...Array(parseInt(item.current_stock))].map((_, i) => (
              <React.Fragment key={`${item.id}-${i}`}>
                <div className="flex border-2 border-black">
                  <div className="flex flex-col justify-center align-middle items-center border-r-2 border-black">
                    <div>
                  ...
                  <div className="flex w-20 flex-col justify-center align-middle items-center px-6 py-4 ">
      ...
      {printItemValue && (
        <div className="grid grid-cols-2 gap-4 mx-4 mt-2">
          {printItemValue.current_stock === undefined ? (
            <div className="flex">
              <div className="flex flex-col justify-center align-middle items-center border-2 border-black">
                <div>
              ...
              <div className="flex flex-col items-center px-6 py-4 border-2 border-black">
